    ...
    <div>
      ...
      <div className='' >
        <form action="" onSubmit={handleSubmit} className='flex flex-col w-[30vw] mx-auto mt-10'>
            ...
            <input type="text" required className='border-2 p-2 text-black'  onChange={onChangeEvent}  value={bookdata.name} placeholder='name of book..' name="name" id="" />
            <label htmlFor="" className='mt-3' >Description</label>
            <textarea name="description" required className='border-2 p-2' id="" onChange={onChangeEvent} value={bookdata.description} placeholder='desc of book..' cols="40" rows="4"></textarea>
            <label htmlFor="" className='mt-3'>Price</label>
            <input type="text" className='border-2 p-2' onChange={onChangeEvent} name="price" value={bookdata.price} placeholder='price of book' id="" />
